...
#Requirements 
You will need RStudio for this class, and should have installed it and be ready to use it before the start of the class. If you do not know how to download it, please follow the instructions available [there](https://malo-jn.quarto.pub/introduction-to-r/session1/0102_setup.html), [there](https://posit.co/download/rstudio-desktop/) or [there](https://cloud.r-project.org/). Download a [file](https://www.rovny.org/s/1_Demo_OLS_review.R) and try to open it on RStudio, to make sure that your environment is working.
