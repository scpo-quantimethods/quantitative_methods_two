...
#| echo: true
library(rio)
ess <- import("/Users/paulservais/Library/CloudStorage/ProtonDrive-paservai@protonmail.com-folder/Website/quantitative_methods_two/sessions/session2/data/ESS_10_fr.csv") %>% 
  select(
    cntry,
    polintr,
    trstplt,
