...
- You can download those following links [elections](https://github.com/paulservais-1/methods_policyevaluation/raw/main/slides/session1/data/elections2024.csv) and [socio-demographic](https://github.com/paulservais-1/methods_policyevaluation/raw/main/slides/session1/data/demographics2024.xlsx).
...
- Adj. $R^2$ gives you the corrected value of $R^2$, taking into account the number of predictors added to the model
